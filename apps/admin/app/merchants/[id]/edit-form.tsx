...
import { updateMerchant, UpdateMerchantData } from './actions';
...
export function EditMerchantForm({ merchant }: EditMerchantFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updateMerchant(merchant.id, formData as UpdateMerchantData);
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-medium text-gray-900">Edit Merchant Information</h2>
                <button
                  onClick={handleCancel}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      This is the email used to log into the merchant portal. Changing this will require re-verification.
                    </p>
                  </div>
