...
import { resendVerificationEmail, impersonateMerchant } from './actions';
...
export function AdminActions({ merchantId, businessName, ownerEmail, emailVerified }: AdminActionsProps) {
  ...
  const handleResendVerification = async () => {
    ...
    try {
      const result = await resendVerificationEmail(merchantId);
      if (result.success) {
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div>
            ...
            <p className="text-xs text-gray-500">Log in as this merchant to provide support</p>
          </div>
          <button
