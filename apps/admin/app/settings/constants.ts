...
export const SETTING_DESCRIPTIONS: Record<SettingKey, string> = {
  ...
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_FEED_INGEST]: 'Retain job history for merchant feed ingest queue',
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_SKU_MATCH]: 'Retain job history for merchant SKU match queue',
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_BENCHMARK]: 'Retain job history for merchant benchmark queue',
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_INSIGHT]: 'Retain job history for merchant insight queue',
...
export const QUEUE_DISPLAY_NAMES: Record<string, string> = {
  ...
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_FEED_INGEST]: 'Merchant Feed Ingest',
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_SKU_MATCH]: 'Merchant SKU Match',
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_BENCHMARK]: 'Merchant Benchmark',
  [SETTING_KEYS.QUEUE_HISTORY_DEALER_INSIGHT]: 'Merchant Insight',
