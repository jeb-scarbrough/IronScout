...
const benefits = [
  ...
  },
  {
    ...
    description: 'Track ROI, conversion rates, and other key metrics through our retailer dashboard.'
  }
]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Join ammunition and tactical gear retailers who are growing their business
