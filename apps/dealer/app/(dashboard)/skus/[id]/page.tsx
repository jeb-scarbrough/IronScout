        ...
        <div className="space-y-6">
          ...
          {sku.canonicalSku && (
            <MarketComparisonCard
              canonicalSku={sku.canonicalSku}
              dealerPrice={Number(sku.rawPrice)}
              dealerPackSize={sku.rawPackSize || sku.parsedPackSize || sku.canonicalSku.packSize}
            />
          )}

          {/* Related Insights */}
          {sku.insights.length > 0 && (
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-medium text-gray-900">Related Insights</h2>
              </div>
              <div className="divide-y divide-gray-200">
                {sku.insights.map((insight) => (
