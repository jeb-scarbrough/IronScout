...
import { prisma, CANONICAL_CALIBERS, type CaliberValue } from '@ironscout/db'
...
// Re-export for consumers that import from gun-locker
export { CANONICAL_CALIBERS, type CaliberValue } from '@ironscout/db'
