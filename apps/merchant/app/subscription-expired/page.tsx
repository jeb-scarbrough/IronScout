...
export default async function SubscriptionExpiredPage() {
  ...
  const expiryDate = merchant.subscriptionExpiresAt
    ? new Date(merchant.subscriptionExpiresAt).toLocaleDateString('en-US', {
        year: 'numeric',
        month: 'long',
        day: 'numeric',
      })
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
          <div className="flex justify-between py-2 border-b border-gray-200">
            ...
            <span className="font-medium text-gray-900">{merchant.tier}</span>
          </div>
          <div className="flex justify-between py-2 border-b border-gray-200">
        ...
        <p className="text-gray-600 text-sm mb-6">
          ...
          Renew now to restore access to your merchant portal and resume
