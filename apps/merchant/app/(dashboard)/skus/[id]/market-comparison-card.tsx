...
export function MarketComparisonCard({
  ...
  const merchantPpr = merchantPrice / merchantPackSize;
  ...
  const diffFromMedian = merchantPpr - marketMedian;
  ...
  const merchantPosition = Math.min(100, Math.max(0, ((merchantPpr - rangeMin) / range) * 100));
      ...
      <div className="px-6 py-4 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-3 rounded-lg bg-gray-50">
            ...
            <p className="text-lg font-bold text-gray-900">${merchantPpr.toFixed(3)}/rd</p>
          </div>
        ...
        <div>
          ...
          <div className="relative h-3 bg-gray-200 rounded-full">
            ...
            <div
              ...
              style={{ left: `calc(${merchantPosition}% - 6px)` }}
            />
          </div>
