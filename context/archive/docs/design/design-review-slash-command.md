...
Follow and implement the design principles and style guide located in context/archive/docs/design/design-principles.md and context/archive/docs/design/style-guide.md.
