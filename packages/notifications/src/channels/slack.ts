 ...
 * 
 * Optional: Use SLACK_WEBHOOK_URL_FEEDS for a separate feed alerts channel
 */
...
export const SLACK_CONFIG = {
  ...
  feedsWebhookUrl: process.env.SLACK_WEBHOOK_URL_FEEDS,
...
export async function sendSlackMessage(
  ...
  const url = webhookUrl || SLACK_CONFIG.webhookUrl;
